				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a class="active" href="i.php">Daily Expense</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					...
					<p>A sure way to lose happiness, I found, is to want it at the expense of everything else.</p>	
					</div>
				</div>
			</div>
		</div>
...
<body>
	...
	<table class="data-table">
		<caption class="title"><h1>That Day Expenses</h1></caption>
		<thead>
			<tr>
