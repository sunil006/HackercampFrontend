				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a class="active" href="month.php">Month Expense</a></li>
							<li>
			...
			<div class="row">
				<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<p>Know the difference between your necessary and discretionary expenses.</p>
					</div>
				</div>
			</div>
		</div>
...
$sql="select Category,SUM(Price) as sm from Expense WHERE MONTHNAME(Date)='$a' group by Category";
...
<body>
	...
	<table class="data-table">
		<caption class="title"><h1>That Month Expenses</h1></caption>
		<thead>
			<tr>
